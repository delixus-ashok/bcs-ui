...
function DEX({ chain, customTokens = {} }) {
  ...
  const [isFromModalActive, setFromModalActive] = useState(true);
  const [isToModalActive, setToModalActive] = useState(true);
  ...
  return (
    <>
      <Card style={styles.card} bodyStyle={{ padding: "18px" }}>
        ...
        >
          <div
            style={{ marginBottom: "5px", fontSize: "14px", color: "white" }}
          >
            From
          </div>
          <div
